...
public class CameraMove : MonoBehaviour
{
    ...
    [SerializeField] GameObject workingLight2;
    ...
    void Start()
    {
        workingLight.SetActive(false);
	  workingLight2.SetActive(false);
    ...
    void Update()
    {
        ...
        {
            this.gameObject.GetComponent<Rigidbody>().useGravity = !this.gameObject.GetComponent<Rigidbody>().useGravity;
        }
